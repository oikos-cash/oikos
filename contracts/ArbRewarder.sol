...
contract ArbRewarder is SelfDestructible, Pausable {
        ...
        returns (uint reward_tokens)
    {
        ...
        require(eth_in_uniswap.divideDecimal(seth_in_uniswap) < uint(divisor-off_peg_min).divideDecimal(divisor), "sTRX/TRX ratio is too high");
        ...
        (uint reward_tokens)
    {
        ...
        uint eth_rate = exchangeRates.rateForCurrency("TRX");
